...
DEFAULT_SETTINGS = {
    ...
    'text_button': u'обратный звонок',
    'text_main': u'<span style="color: #FAD468;">Здравствуйте!</span><br/>Получить 25% скидку на любой товар на нашем сайте очень легко!<br/>Просто закажите обратный звонок прямо сейчас.',
    'text_dial_ready': u'Подготовка соединения...',
    'text_dial_start': u'Ожидайте звонка!<br/>Производится соединение с сервером...',
    'text_dial_connected': u'Ожидайте звонка!<br/>Идет набор номера оператора...',
    'text_dial_calling': u'Ожидайте звонка!<br/>Оператор на связи, производится набор введенного номера телефона.',
    'text_dial_success': u'Соединение установлено!<br/>Возьмите трубку.',
    'text_dial_refused': u'Оператор не доступен, или занят в данный момент.<br/>Попробуйте чуть позже.',
    'text_dial_dropped': u'Похоже что вы не подняли трубку или сбросили вызов.',
    'text_dial_out_of_balance': u'Извините, сервис в данной момент не доступен.<br/>Просим прощение за доставленные неудобства.',
    'text_dial_late': u'Оператор не успел поднять трубку.',
    'text_dial_failed': u'Извините, сервис в данной момент не доступен.<br/>Просим прощение за доставленные неудобства.',
    'text_dial_finished': u'Соединение завершено.',
    'text_order_start': u'Выберите удобное время звонка',
    'text_order_done': u'Спасибо!<br/>Мы обязательно перезвоним Вам в указанное время.',
    'text_order_failed': u'Извините, сервис в данной момент не доступен.<br/>Просим прощение за доставленные неудобства.',
    'text_message_start': u'Постараемся ответить на Ваш вопрос как можно скорее',
    'text_message_sent': u'Спасибо за ваше сообщение!<br/>Мы обязательно свяжемся с вами в ближайшее время.',
    'text_message_failed': u'Извините, сервис в данной момент не доступен.<br/>Просим прощение за доставленные неудобства.',
    'text_send_message_done': u'Спасибо за Ваше сообщение!<br/>Мы обязательно свяжемся с Вами в ближайшее время.',
    'text_timeoff_start': u'<span style="color: #FAD468;">Здравствуйте!</span><br/>К сожалению наш рабочий день уже закончился. Пожалуйста оставьте Ваш номер телефона и выберите удобное время звонка.',
    'text_timeoff_done': u'Спасибо!<br/>Мы обязательно перезвоним Вам в указанное время.',
    'text_free_start': u'<span style="color: #FAD468;">Здравствуйте!</span><br/>Оставьте Ваш номер телефона и выберитcolor_background_image_globalе удобное время звонка. Мы перезвоним и проконсультируем по всем вопросам.',
    'text_free_done': u'Спасибо!<br/>Мы обязательно перезвоним Вам в указанное время.',
    'text_link_order': u'Выбрать удобное время звонка',
    'text_link_send_message': u'Написать сообщение',
    'text_link_go_back': u'Назад',
    'text_link_message_go_back': u'Заказать звонок',
